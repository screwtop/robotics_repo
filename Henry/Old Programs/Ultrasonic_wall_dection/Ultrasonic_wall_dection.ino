...
const float RIGHT_MOTOR_SPEED_FACTOR = 1.7;
const int MAX_PWM_DUTY_CONST = 240; //240 for Carpet,220 for wood
const int SLOW_PWM_DUTY_CONST = 160; //180 for Carpet, 150 for wood
...
void setup()
{
  ...
  digitalWrite (Button1Pin, HIGH); //Enables pullup resistor for the pin
